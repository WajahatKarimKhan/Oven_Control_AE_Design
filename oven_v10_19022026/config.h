...
// PID Configuration
const int PID_COMPUTE_FREQ = 500; // Compute every 100ms
const int PID_WINDOW_SIZE = 30000; // Time Proportional Control Window
...
const double ROD1_DEFAULT_KP = 4.5;  // 6000>>>250 .. 15000>>>650
const double ROD1_DEFAULT_KI = 0.0;   
const double ROD1_DEFAULT_KD = 0.0;    

// ROD 2: Lower (Induction)
const double ROD2_DEFAULT_KP = 15.0;  // 6000>>>450 .. 15000>>>1125 
const double ROD2_DEFAULT_KI = 0.0;    
const double ROD2_DEFAULT_KD = 0.0;    

// ROD STEAM: Steam Generator
const double STEAM_DEFAULT_KP = 10.0; // 6000>>>450 .. 15000>>>1125
const double STEAM_DEFAULT_KI = 0.0;  
const double STEAM_DEFAULT_KD = 0.0; 

const double TOPPID_RS[3] = {8 , 0, 0};
const double BOTPID_RS[3] = {15, 0, 0};
const double STMPID_RS[3] = {13, 0, 0};
