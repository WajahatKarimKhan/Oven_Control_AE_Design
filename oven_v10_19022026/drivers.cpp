...
const long statusUpdateInterval = 100; // communication time with lcd
...
QuickPID pidRod1(&pidInputRod1, &pidOutputRod1, &pidSetpointRod1, 0, 0, 0, QuickPID::DIRECT, TOPROD);
QuickPID pidRod2(&pidInputRod2, &pidOutputRod2, &pidSetpointRod2, 0, 0, 0, QuickPID::DIRECT, BOTTOMROD);
QuickPID pidSteam(&pidInputSteam, &pidOutputSteam, &pidSetpointSteam, 0, 0, 0, QuickPID::DIRECT, STEAMROD);
